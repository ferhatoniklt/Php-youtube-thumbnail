...
<head>
  ...
  <title>YouTube Video Thumbnail İndirme </title>
  <link rel="stylesheet" href="style.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"/>
</head>
<body>
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
    <header>YouTube Video Thumbnail İndirme </header>
    <div class="url-input">
    ...
    <div class="preview-area">
      ...
      <span>Video Url Yapıştırınız !</span>
    </div>
    <button class="download-btn" type="submit" name="button">İndir</button>
  </form>
